...
double-pushout (DPO) approach in adhesive categories. We pair this with
...
\begin{enumerate}[leftmargin=5mm]
  ...
  \item \emph{Worldline uniqueness} (Corollary~\ref{cor:worldline-uniqueness}):
    the interior derivation is uniquely determined up to typed open
    graph isomorphism by the boundary data, extending per-tick
    commutation to whole-run semantics;
