...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    \begin{scope}[shift={(0,-2.8)}]
      \draw[rounded corners,thick,gray!40] (-0.3,-0.6) rectangle (5.0,0.6);
      \node[node,del] (ld) at (0,0) {};
      \node[anchor=west] at (0.4,0) {\scriptsize delete $\Del(m_i)$};
      \node[node,use] (lu) at (2.6,0) {};
      \node[anchor=west] at (3.0,0) {\scriptsize use $\Use(m_i)$};
    \end{scope}
  \end{tikzpicture}
