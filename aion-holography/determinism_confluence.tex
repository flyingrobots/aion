...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    \node[node,del] (ld) at (5.1,0.6) {};
    \node[anchor=west] at (5.5,0.6) {\scriptsize delete $\Del(m_i)$};
    \node[node,use] (lu) at (5.1,-0.4) {};
    \node[anchor=west] at (5.5,-0.4) {\scriptsize use $\Use(m_i)$};
  \end{tikzpicture}
