...
\subsection{Footprints, independence, and scheduler--admissible batches}

We work at the level of the skeleton plane.  Let
...
$S : G \Rewrite G'$ be a composite of skeleton DPOI steps in the base
induced by rules in $R$ such that the tick consisting of $A$ followed
by $S$ satisfies the no-delete/no-clone-under-descent invariant.  Then
