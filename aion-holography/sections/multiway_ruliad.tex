...
geometry, and the Chronos/Kairos/Aion time model from the AI$\Omega$N calculus
(note) gives a temporal structure on branches and merges.

A more detailed study of this correspondence is left for future work,
and will be taken up in the companion C$\Omega$MPUTER paper, where we
