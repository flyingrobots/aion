...
$0,\ldots,k{-}1$.  The \emph{infinite unfolding}
$\mathrm{unf}_\infty(X)$ is the directed colimit of the
$k$-unfoldings.  Because $F$ is finitary and $\RMG$ is the initial
$F$-algebra, these colimits remain finitely branching and support the
same structural recursion principles.  The unfoldings thus let us
