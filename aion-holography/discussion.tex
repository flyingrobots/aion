...
\paragraph{Determinism invariants (Echo).}
In the concrete \AION{} runtime (Echo), the semantic assumptions above
are enforced by a set of operational invariants; any violation aborts
...
\end{itemize}
These invariants guide both implementation and test suites and ensure
