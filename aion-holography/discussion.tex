...
In the concrete \AION{} runtime (Echo), these semantic assumptions are
enforced as determinism invariants---world-hash equivalence, merge
determinism, temporal stability, and replay integrity---which ensure
that the abstract confluence properties proven here manifest as
bit-level reproducibility in practice.
